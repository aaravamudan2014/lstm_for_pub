...
python3 main.py --n_splits=$nsplits --seed=$firstseed --huc=$huc --experiment=$exp --concat_static=True --run_dir="runs/${run_dir}" --split_file="data/kfold_splits_seed$firstseed.p" evaluate
wait
